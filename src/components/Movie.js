...
const Movie = (props) => {
    ...
    // ambil gambar poser untuk setiap movie
    const getImage = () => {
    ...
    return (
        <div className='movie-container col-6 col-md-4 col-xl-3 mb-5'>
            ...
            <img src={getImage()} alt={props.movie.title} className="w-100 img-thumbnail"></img>
